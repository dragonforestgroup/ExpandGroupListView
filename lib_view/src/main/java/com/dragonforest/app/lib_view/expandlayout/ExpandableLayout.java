package com.dragonforest.app.lib_view.expandlayout;
...
import com.dragonforest.app.lib_view.expandlayout.util.FastOutSlowInInterpolator;


import static com.dragonforest.app.lib_view.expandlayout.ExpandableLayout.State.COLLAPSED;
import static com.dragonforest.app.lib_view.expandlayout.ExpandableLayout.State.COLLAPSING;
import static com.dragonforest.app.lib_view.expandlayout.ExpandableLayout.State.EXPANDED;
import static com.dragonforest.app.lib_view.expandlayout.ExpandableLayout.State.EXPANDING;

/**
 * 可伸缩的layout,被包装的任意view会变成可伸缩的
 *
 * @author 韩龙林
